    ...
    <div className="mini-nav">
      <div className="container">
        <div className="mini-nav-wrapper">
          <a href="tel:(888)123-4567" className="mini-nav-tel">
            <IoCallOutline className="tel-icon" />
            <p className="tel-text">need help?</p>
            <p className="tel-text">(888) 123-4567</p>
          </a>
          <div className="mini-nav-content">
            <div className="mini-nav-truck">
              <PiTruck className="tel-icon" />
              <p className="tel-text">Enjoy Free Delivery</p>
            </div>
            <div className="mini-nav-truck">
              <TfiHeadphoneAlt className="tel-icon" />
              <p className="tel-text">24*7 customer care</p>
            </div>
            <div className="mini-nav-truck">
              <RiSecurePaymentLine className="tel-icon" />
              <p className="tel-text">Secure Payment</p>
            </div>
          </div>
          <div className="mini-nav-content-v2">
            <p className="tel-text">follow us:</p>
            <a href="https://www.facebook.com">
              <FiFacebook className="tel-icon" />
            </a>
            <a href="https://www.instagram.com">
              <FaInstagram className="tel-icon" />
            </a>
            <a href="https://www.twitter.com">
              <FaXTwitter className="tel-icon" />
            </a>
          </div>
        </div>
      </div>
    ...
    <div className="main-nav">
      <div className="container">
        <div className="main-nav-wrapper">
          <ul className={`main-nav-list ${menuOpen ? "open" : ""}`}>
            <li className="main-nav-option">
              <a href="#" className="main-option">
                Home 
              </a>
            </li>
            <li className="main-nav-option">
              <Link href="/shop" className="main-option">
                Shop
              </Link>
            </li>
            <li className="main-nav-option">
              {/* <Block className="main-option">Shop</Block> */}
            </li>
            <li className="main-nav-option">
              <Link href="/contact" className="main-option">
                Contact
              </Link>
            </li>
          </ul>

          <a href="#" className="main-img-content">
            <svg

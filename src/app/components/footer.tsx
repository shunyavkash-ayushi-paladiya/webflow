      ...
      <div className="container-v2">
        ...
        <div className="footer-wrapper">
          <div className="footer-options-list">
            <h2 className="footer-option-title">Useful links</h2>
            <ul className="footer-option-list">
              <li>
                <a href="#" className="footer-option">
                  Home
                </a>
              </li>
              <li>
              ...
              <li>
                <Link href="/blog" className="footer-option">
                  Blog
                </Link>
              </li>
              <li>
                <a href="/about" className="footer-option">
                  Shop
                </a>
              </li>
              <li>
          ...
          <div className="footer-img-content">
            <img
              src="https://ik.imagekit.io/fa1ylzjml/685e1a7a491ba0a3b7ee8472_footer-iamge.webp?updatedAt=1759985633152"
              className="footer-img"
            />
          </div>
          <div className="footer-contact-content">
            <h2 className="footer-option-title">Get in touch</h2>
            <ul className="footer-contact-list">
              <li>
                <a href="tel:(888) 1234 - 567" className="contact-info">
                  <MdOutlinePhone className="footer-icon" />
                  <p className="footer-text">(888) 1234 - 567</p>
                </a>
              </li>
              <li>
                <a href="mailto:info@example.com" className="contact-info">
                  <CiMail className="footer-icon" />
                  <p className="footer-text">info@example.com</p>
                </a>
              </li>
              <li> 
                <a href="https://maps.app.goo.gl/yZMgQ6WfraQCAaDS7" className="contact-info">
                  <CiLocationOn className="footer-icon" />
                  <p className="footer-text">480 Sandtown, california 124, USA</p>
                </a>
              </li>
            </ul>
          </div>
